...
#include "../include/monster_generated.h"
...
int main(int argc, const char *argv[]) {
  ...
  names_data.push_back(builder.CreateString("Aman"));
  ...
  printf("The FlatBuffer was successfully created and verified person group!\n");
